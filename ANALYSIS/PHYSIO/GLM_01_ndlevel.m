...
%% DEFINE POPULATION
control = [homedir 'DERIVATIVES/GLM/PSPM/PAV/GLM-01/sub-control*/output/GLM-01.mat'];
obese = [homedir 'DERIVATIVES/GLM/PSPM/PAV/GLM-01/sub-obese*/output/GLM-01.mat'];
...
matlabbatch{1}.pspm{1}.second_level{1}.contrast.outdir = {[homedir 'DERIVATIVES/GLM/PSPM/PAV/GLM-01/group']};
matlabbatch{1}.pspm{1}.second_level{1}.contrast.filename = 'group_GLM_01';
