...
%[heatmapRGB,heatmap,scene] = heatmap_generator([meangazeX, meangazeY],'Background.bmp',0.100,1,1,5,3);
function [heatmapRGB,heatmap,scene]=heatmap_generator(records,scene,spacing,max_hor,max_ver,kernel_size_gaussian,s_gaussian)
...
for i=1:size(R,1)%1024
    for j=1:size(R,2)%1280
