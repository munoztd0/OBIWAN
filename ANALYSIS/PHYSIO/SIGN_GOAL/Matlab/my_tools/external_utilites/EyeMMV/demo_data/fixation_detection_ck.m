...
%  Last modifed by Eva on Feb 2017
...
function [fixation_list_t2,fixation_list_3s]= fixation_detection_ck('data_stimulus_demo.txt',0.250,0.100,150,1.25,1.00);
%load data from file
data=load(data);
x=data(:,1);
y=data(:,2);
...
%     my=mean(y(fixpointer:i));
    ...
    mx=nanmean(x(fixpointer:i)); % I changed this to nanmean
    my=nanmean(y(fixpointer:i));
