...
function [fixations]=ROI_analysis(fixation_list,rois,roi_to_analyze,displayplot)
%rois=load(rois);
...
item_average = zeros (1,3);%%%%%%%%%%%%%%%%%%%%%% aggiunto da me
fixations.item_average =item_average;
for i=1:length(x_fix)
...
fixations.allfixations = fixations_in_roi;
if n_fixations>=1 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ATTENTION I ADDED THE =
    ...
    fixation_in_roi_averaged = [mean_duration_roi,fixations_percentage_roi,duration_percentage_roi];
    fixations.item_average = fixation_in_roi_averaged;
