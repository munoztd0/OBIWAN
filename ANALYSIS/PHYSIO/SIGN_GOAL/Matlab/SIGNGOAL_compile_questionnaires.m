...
% AS A CHECK TRY ONE PARTICIPANT BY HAND AND SEE IF YOU OBTAIN THE SAME
% RESULTS
...
analysis_name     = 'Questionnaires-SIGNGOAL';
...
filename = fullfile(questionnaire_dir, 'BIS_11.csv');
delimiterIn = ';';
headerlinesIn = 1;
...
filename = fullfile(questionnaire_dir, 'OCI_R.csv');
delimiterIn = ';';
headerlinesIn = 1;
...
filename = fullfile(questionnaire_dir, 'STAI_T.csv');
delimiterIn = ';';
headerlinesIn = 1;
...
filename = fullfile(questionnaire_dir, 'CAST.csv');
delimiterIn = ';';
headerlinesIn = 1;
...
filename = fullfile(questionnaire_dir, 'AUDIT.csv');
delimiterIn = ';';
headerlinesIn = 1;
...
filename = fullfile(questionnaire_dir, 'CDS_12.csv');
delimiterIn = ';';
headerlinesIn = 1;
...
filename = fullfile(questionnaire_dir, 'BISBAS.csv');
delimiterIn = ';';
headerlinesIn = 1;
...
subscale.BISBAS_total       = subscale.BAS_drive + subscale.BAS_Fun_seeking + subscale.BAS_reward_responsivness + subscale.BIS;
...
BISBAS.all.headers          = [BISBAS.colheaders, 'BAS_drive',          'BAS_Fun_seeking',         'BAS_reward_responsivness',           'BIS',       'BISBAS_total'];
