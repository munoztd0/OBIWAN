...
run = {'RUN_1_TR2400_TE41_1800um_0007'}; %PIT
...
subj={'01'}; %'20'; '21'; '22'; '23'; '24'; '25'; '26'};
    %'03'; '04'; '05'; '06'; '07'; '09'; '11'; '13'; '15'; '17'; '18'
...
for  i=1:length(subj)
    ...
    run1 = cell2mat(strfind (run, 'RUN_1_TR2400_TE41_1800um_0007'));
    if run1
        physioRunID = '_PIT';
    else
        physioRunID = '_EVAL';
    ...
    if run1
        ...
        grip_channel = 5;
        MRI_volume = 2;
        num_channel = 5; %channels of interest
