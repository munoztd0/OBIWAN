...
% Smell - No Smell !!
% last modified on March 2019 by David
...
for  i=1:length(subj)
    ...
    condition = CONDITIONS(~strcmp ('neutral', CONDITIONS));
    
    %miniruns = reshape(repmat ([1: 6], 9,1), 1, [])';
    miniruns = reshape(repmat ([1: 6], 6,1), 1, [])';

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % Get onsets and durations for the whole duration
    onsets.All          = ONSETS.sniffSignalOnset(~strcmp ('neutral', CONDITIONS));
