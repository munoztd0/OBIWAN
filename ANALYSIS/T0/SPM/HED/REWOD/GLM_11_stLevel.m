...
name_ana = 'GLM-11'; % output folder for this analysis
...
subj       =  {'23'}; %{'01';'02';'03';'04';'05';'06';'07';'09';'10';'11';'12';'13';'14';'15';'16';'17';'18';'20';'21';'22';'23';'24';'25';'26';}; %subID;
param.task = {'hedonic'};
...
for i = 1:length(param.task)
    ...
    param.Cnam{i} = {'start',... %1
     ...
     param.onset{i} = {'ONS.onsets.trialstart',... %1
        'ONS.onsets.odor.conc1', ...
        'ONS.onsets.odor.conc2', ...
        'ONS.onsets.liking',...%5 
    ...
    param.duration{i} = {'ONS.durations.trialstart',...
        'ONS.durations.odor.conc1',...
        'ONS.durations.odor.conc2',...
    ...
    param.modul{i} = {'none',...%1
        'ONS.modulators.odor.conc1',... %2
        'ONS.modulators.odor.conc2',... %2
        'none',... %3
        'none'}; %6
...
%% function section
    ...
    function [] = doContrasts(subjoutdir, param, SPM)
        ...
        % con1
        Ctnames{1} = 'odor_int1';
        weightPos  = ismember(conditionName, {'task-hed.odor1xint^1'}) * 1; 
        Ct(1,:)    = weightPos;
        
     
        %con2
        Ctnames{2} = 'odor_lik1';
        weightPos  = ismember(conditionName, {'task-hed.odor1xlik^1'}) * 1; 
        Ct(2,:)    = weightPos;
        
       % con3
        Ctnames{3} = 'odor_int2';
        weightPos  = ismember(conditionName, {'task-hed.odor2xint^1'}) * 1; 
        Ct(3,:)    = weightPos;
        
     
        %con4
        %Ctnames{4} = 'odor_lik2';
        %weightPos  = ismember(conditionName, {'task-hed.odor2xlik^1'}) * 1; 
        %Ct(4,:)    = weightPos;
        
         %con5
        %Ctnames{5} = 'odor_lik1-2';
        %weightPos  = ismember(conditionName, {'task-hed.odor1xlik^1'}) * 1; 
        %weightNeg  = ismember(conditionName, {'task-hed.odor2xlik^1'})* -1;%
