...
for i = 1:length(param.task)
    ...
    param.modul{i} = {'none',...%1
        'ONS.modulators.odor.reward1.lik',...
        'ONS.modulators.odor.control1.lik',...
        'ONS.modulators.odor.neutral1.lik',... 
        'ONS.modulators.odor.reward2.lik',...
        'ONS.modulators.odor.control2.lik',...
        'ONS.modulators.odor.neutral2.lik',... 
        'none',... %3
        'none'}; %6
...
%% function section
    ...
    function [] = doContrasts(subjoutdir, param, SPM)
        ...
        %%%%%%%%%%%%% mod runs %%%%%%%%%%
         ...
         % con4
        Ctnames{4} = 'reward1-control2_RUN';
        weightPos  = ismember(conditionName, {'task-hed.reward1xlik^1'}) * 1; %
        weightNeg  = ismember(conditionName, {'task-hed.control2xlik^1'})* -1;%
        Ct(4,:)    = weightPos+weightNeg;
        
        % con5
        Ctnames{5} = 'reward1-neutral2_RUN';
        weightPos  = ismember(conditionName, {'task-hed.reward1xlik^1'}) * 1;
        weightNeg  = ismember(conditionName, {'task-hed.neutral2xlik^1'})* -1;
        Ct(5,:)    = weightPos+weightNeg; 
        
        % con6
        Ctnames{6} = 'Reward1-NoReward2_RUN';
        weightPos  = ismember(conditionName, {'task-hed.reward1xlik^1'}) * 2;
        weightNeg  = ismember(conditionName, {'task-hed.control2xlik^1', 'task-hed.neutral2xlik^1'}) * -1;
        ...
        % con8
        Ctnames{8} = 'Reward1-NoReward1and2_RUN';
        weightPos  = ismember(conditionName, {'task-hed.reward1xlik^1'}) * 4;
        weightNeg  = ismember(conditionName, {'task-hed.control1xlik^1', 'task-hed.neutral1xlik^1', 'task-hed.control2xlik^1', 'task-hed.neutral2xlik^1'}) * -1;
