...
def make_targets(subj, glm_ds_file, mask_name, runs2use, class_dict):

    start_time = time.time()
    print 'Starting making targets',time.time() - start_time
    
    onsets_folder = '/Users/logancross/Documents/EvaPavlovian/analysis/timing_files/sub-'+subj+'/'
    
    trial_list = []
    trial_categ_list = []
    chunks_list = []
    for run in range(1,4):
        temp_folder = onsets_folder+'GLM-01_run-0'+str(run)
