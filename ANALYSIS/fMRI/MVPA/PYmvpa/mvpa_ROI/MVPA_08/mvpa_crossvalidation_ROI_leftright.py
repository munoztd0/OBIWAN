...
roi_list= ['INSleftROI', 'INSrightROI', 'LOCleftROI', 'LOCrightROI', 'SMAROI', 'VSrightROI', 'VSleftROI', 'VSROI', 'VTAROI']

roi_list = ['RPE_VMPF_ROI','RPE_VS_ROI','RPE_VTA_ROI', 'RPE_VTA_ROI', 'SPE_SFG_ROI', 'SPE_VTA_ROI', 'SPE_left_MFG_ROI', 'SPE_left_OFC_ROI','SPE_right_MFG_ROI','SPE_right_OFC_ROI']
...
for roi in range (0,len(roi_list)):
    ...
    for sub in range(0,len(sub_list)):
        ...
        fds = mvpa_utils_pav.make_targets08(subj, glm_ds_file, mask_name, runs2use, class_dict08, homedir, ana_name)
    ...
    plt.legend()
    fname = homedir+'ANALYSIS/mvpa_scripts/PYmvpa/mvpa_ROI/MVPA_08/ROI_from_GLM-MF-09a/CSp_CSm_Classdic8'+roix+'_3runs.pdf'
    plt.savefig(fname)
