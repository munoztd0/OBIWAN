...
name_soft = 'FSL'; % output folder for this analysis
...
covdir   = fullfile (homedir, 'DERIVATIVES/GLM/', name_soft, task, name_ana, 'group_covariates'); % director with the extracted second level covariates
...
covariateNames = {'rew_con_lik_ob'; 'rew_con_lik_hw'}; %9
contrastX = 'reward-control';%2 Only one at a time now
