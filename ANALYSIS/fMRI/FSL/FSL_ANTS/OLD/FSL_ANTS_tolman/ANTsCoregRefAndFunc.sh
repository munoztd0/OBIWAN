...
flirt -in ${icaDir}func_mean_bias -ref ${moving_T2} -dof 6 -cost normcorr -out ${icaDir}tmp_Func_to_T2 -omat ${icaDir}tmp_Func_to_T2.mat
# second run to flirt to affine alignemnt
flirt -in ${icaDir}func_mean_bias -ref ${moving_T2} -dof 12 -cost normcorr -init ${icaDir}tmp_Func_to_T2.mat -nosearch -out ${icaDir}tmp_Func_to_T2_improved -omat ${icaDir}tmp_Func_to_T2.mat
