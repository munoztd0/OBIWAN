...
name_ana = 'GLM-10'; % output folder for this analysis
...
%% function section
    ...
    function [] = doContrasts(subjoutdir, param, SPM)
        ...
        %%%% number 2
        % con6
        Ctnames{6} = 'reward1-control2';
        weightPos  = ismember(conditionName, {'task-hed.reward2'}) * 1; %
        weightNeg  = ismember(conditionName, {'task-hed.control2'})* -1;%
        Ct(6,:)    = weightPos+weightNeg;
        
        % con7
        Ctnames{7} = 'reward2-neutral2';
        weightPos  = ismember(conditionName, {'task-hed.reward2'}) * 1;
        ...
        % con8
        Ctnames{8} = 'Reward1-NoReward1';
        weightPos  = ismember(conditionName, {'task-hed.reward2'}) * 2; 
