...
if do_ttest
    ...
    contrastNames = {'run1_reward1_neutral1'
        'run1_reward1_neutral2'
        'run1&2_reward1_neutral1'
        'run1&2_reward1_neutral2'
        'run1&2&3_reward1_neutral1'
        'run1&2&3_reward1_neutral2'
        'run1_Reward1_NoReward1'
        'run1_Reward1_NoReward2'
        'run1&2_Reward1_NoReward1'
        'run1&2_Reward1_NoReward2'
        'run1&2&3_Reward1_NoReward1'
        'run1&2&3_Reward1_NoReward2'
        'run1&2&3_reward1&2_neutral1&2'
        'run1&2&3_Reward1&2_NoReward2'};%2
    ...
    conImages = {'con_0001'
        ...
        'con_0011'
        'con_0012'
        'con_0013'  %16 not a spelling error
        'con_0014'};
    ...
    for n = 1:length(contrastNames)
        ...
        if remove
           contrastFolder = fullfile (groupdir, 'ttests', ['removing-' removedsub], contrastX);
            ...
            contrastFolder = fullfile (groupdir, 'ttests', 'all2', contrastX);
        end
