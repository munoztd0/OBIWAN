...
% 8 basic contrasts Reward-Control, Reward-Neutral, Odor-NoOdor, odor_presence
...
if do_ttest
    ...
    contrastNames = {'reward1-control2'%1
        'reward1-neutral2'%2
        'Reward1-NoReward2'%3
        'reward1-control2_RUN'%1
        'reward1-neutral2_RUN'%2
        'Reward1-NoReward2_RUN'
        'reward1-NoReward1and2'
        'Reward1-NoReward1and2_RUN'};%7
