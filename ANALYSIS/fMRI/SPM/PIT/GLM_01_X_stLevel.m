...
if sessionX == 'second'
    name_ana = 'GLM-01_0'; % output folder for this analysis
     ...
     name_ana = 'GLM-01_1'; % output folder for this analysis
end
...
mdldir   = fullfile (homedir, '/DERIVATIVES/GLM/AFNI', task);% mdl directory (timing and outputs of the analysis)
...
for i = 1:length(subj)
    ...
    if copycontrasts == 1
        ...
        % copy images T
        Timages = ['01'; '02'];% '06'; '07'];% constrasts of interest
