...
%R_N = CONTRAT 2   
%R_NoR = CONTRAT 5 
%R_NoR1 = CONTRAT 4 for hglm 09
%lik = CONTRAT 2 
%9 - Reward1-NoReward1 - 4
...
dir_data   =  fullfile (homedir, '/DERIVATIVES/ANALYSIS', task_name, glm, 'group');
roi_dir = fullfile(homedir, '/DERIVATIVES/ANALYSIS/CONJ', ROI_name);
