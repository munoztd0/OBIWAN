...
# open datasets
cov <- read.delim(file.path(data_path,'PIT_covariateT0.txt'), header = T, sep ='\t') # 
...
cov <- filter(cov, id %notin% c(104, 110, 111, 117, 200, 212, 218, 224, 243, 255, 257, 260, 261))



#center covariates
numer <- c("adiponectin_V3", "obestatin_V3",   "glucagon_V3",    "reelin_V3",      "Creat_V3",  "GFR_V3","ALT_V3","AST_V3","Na_V3","K_V3","ChTot_V3","HDL_V3","LDL_V3","TG_V3", "Gly_v3" ,"HbA1c_V3" ,"Insulin_V3","TSH_V3","RBC_V3","Hb_V3" ,"Ht_V3","Leu_V3","Tr_v3","BMI_t1","age", "piss", "thirsty", 'hungry','force')
