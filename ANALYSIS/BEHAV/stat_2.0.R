...
pacman::p_load(tidyverse, ggplot2, Rmisc, dplyr, lmerTest, car, r2glmm, optimx, visreg, MuMIn,  pbkrtest, bootpredictlme4, sjPlot, emmeans)
...
OBIWAN_HED$session    <- as.factor(OBIWAN_HED$session)
...
OBIWAN_HED  <- subset(OBIWAN_HED, id != 242 & id != 256 & id != 234)
...
OBIWAN_HED$time = OBIWAN_HED$session
#************************************************** test (BAD)
mdl.liking = lmer(perceived_liking ~ condition*time*intervention + trialxcondition + bmi_diff_z + gender + ageZ + (condition|id)+ (condition|trialxcondition), data = OBIWAN_HED, REML=FALSE)
anova(mdl.liking)
...
#OUT bc degenerated hessian mod1 = lmer(perceived_liking ~ condition*time*intervention +  bmi_diff_z + gender + ageZ + (time*intervention*condition|id), data = OBIWAN_HED)
#OUT bc degenerated hessian mod2 = lmer(perceived_liking ~ condition*time*intervention +  bmi_diff_z + gender + ageZ + (time*intervention+condition|id), data = OBIWAN_HED)
#OUT bc degenerated hessian mod3 = lmer(perceived_liking ~ condition*time*intervention +  bmi_diff_z + gender + ageZ + (time+intervention*condition|id), data = OBIWAN_HED)
mod4 = lmer(perceived_liking ~ condition + time + intervention   + condition:intervention + time:intervention + time:intervention:condition +  bmi_diff_z + gender + ageZ + (time*condition+intervention|id)  + (1|trialxcondition), data = OBIWAN_HED)
mod5 = lmer(perceived_liking ~ condition + time + intervention   + condition:intervention + time:intervention + time:intervention:condition +  bmi_diff_z + gender + ageZ + (time*condition|id) + (1|trialxcondition), data = OBIWAN_HED)
# mod6 = lmer(perceived_liking ~ condition + time + intervention   + condition:intervention + time:intervention + time:intervention:condition +  bmi_diff_z + gender + ageZ + (time:condition + condition + intervention|id) + (1|trialxcondition), data = OBIWAN_HED)
# mod7 = lmer(perceived_liking ~ condition + time + intervention   + condition:intervention + time:intervention + time:intervention:condition +  bmi_diff_z + gender + ageZ + (time:condition + time + intervention|id) + (1|trialxcondition), data = OBIWAN_HED)
# mod8 = lmer(perceived_liking ~ condition + time + intervention   + condition:intervention + time:intervention + time:intervention:condition +  bmi_diff_z + gender + ageZ + (time:condition + condition |id) + (1|trialxcondition), data = OBIWAN_HED)
# mod9 = lmer(perceived_liking ~ condition + time + intervention   + condition:intervention + time:intervention + time:intervention:condition +  bmi_diff_z + gender + ageZ + (time:condition + time |id) + (1|trialxcondition), data = OBIWAN_HED)
# mod10 = lmer(perceived_liking ~ condition + time + intervention   + condition:intervention + time:intervention + time:intervention:condition +  bmi_diff_z + gender + ageZ + (time:condition |id) + (1|trialxcondition), data = OBIWAN_HED)
# mod11 = lmer(perceived_liking ~ condition + time + intervention   + condition:intervention + time:intervention + time:intervention:condition +  bmi_diff_z + gender + ageZ + (time+condition |id) + (1|trialxcondition), data = OBIWAN_HED)
# mod12 = lmer(perceived_liking ~ condition + time + intervention   + condition:intervention + time:intervention + time:intervention:condition +  bmi_diff_z + gender + ageZ + (condition |id) + (1|trialxcondition), data = OBIWAN_HED)
# mod13 = lmer(perceived_liking ~ condition + time + intervention   + condition:intervention + time:intervention + time:intervention:condition +  bmi_diff_z + gender + ageZ + (time |id) + (1|trialxcondition), data = OBIWAN_HED)
# mod14 = lmer(perceived_liking ~ condition + time + intervention   + condition:intervention + time:intervention + time:intervention:condition +  bmi_diff_z + gender + ageZ + (1 |id) + (1|trialxcondition), data = OBIWAN_HED)
...
slope.model = lmer(perceived_liking ~ condition + time + intervention   + condition:intervention + time:intervention + time:intervention:condition +  bmi_diff_z + gender + ageZ + (1|id) + (1|trialxcondition), data = OBIWAN_HED, control=control)
random.slope.model = lmer(perceived_liking ~ condition + time + intervention   + condition:intervention + time:intervention + time:intervention:condition +  bmi_diff_z + gender + ageZ + (time*condition|id) + (1|trialxcondition), data = OBIWAN_HED, control=control)
...
full = lmer(perceived_liking ~ condition + time + intervention  + condition:time + condition:intervention + time:intervention  + time:intervention:condition +  bmi_diff_z + gender + ageZ + (time*condition|id) + (1|trialxcondition), data = OBIWAN_HED, control=control, REML = FALSE)
#drop inter
null = lmer(perceived_liking ~ condition + time + intervention  + condition:time + condition:intervention + time:intervention +  bmi_diff_z + gender + ageZ + (time*condition|id) + (1|trialxcondition), data = OBIWAN_HED, control=control, REML = FALSE)
...
full = lmer(perceived_liking ~ condition + time + intervention  + condition:time + condition:intervention + time:intervention  +  bmi_diff_z + gender + ageZ + (time*condition|id) + (1|trialxcondition), data = OBIWAN_HED, control=control, REML = FALSE)
#drop inter
null = lmer(perceived_liking ~ condition + time + intervention  + condition:time + condition:intervention +  bmi_diff_z + gender + ageZ + (time*condition|id) + (1|trialxcondition), data = OBIWAN_HED, control=control, REML = FALSE)
...
full = lmer(perceived_liking ~ condition + time + intervention   + condition:time + condition:intervention + time:intervention  +  bmi_diff_z + gender + ageZ + (time*condition|id) + (1|trialxcondition), data = OBIWAN_HED, control=control, REML = FALSE)
#drop inter
null = lmer(perceived_liking ~ condition + time + intervention   + condition:time + time:intervention  +  bmi_diff_z + gender + ageZ + (time*condition|id) + (1|trialxcondition), data = OBIWAN_HED, control=control, REML = FALSE)
...
full = lmer(perceived_liking ~ condition + time + intervention   + condition:time + condition:intervention + time:intervention  +  bmi_diff_z + gender + ageZ + (time*condition|id) + (1|trialxcondition), data = OBIWAN_HED, control=control, REML = FALSE)
#drop inter
null = lmer(perceived_liking ~ condition + time + intervention   + time:intervention  +  bmi_diff_z + gender + ageZ + (time*condition|id) + (1|trialxcondition), data = OBIWAN_HED, control=control, REML = FALSE)
...
full = lmer(perceived_liking ~ condition + time + intervention   + condition:time  +  bmi_diff_z + gender + ageZ + (time*condition|id) + (1|trialxcondition), data = OBIWAN_HED, control=control, REML = FALSE)
#drop main
null = lmer(perceived_liking ~ condition + time + condition:time   +  bmi_diff_z + gender + ageZ + (time*condition|id) + (1|trialxcondition), data = OBIWAN_HED, control=control, REML = FALSE)
...
full = lmer(perceived_liking ~ condition + time + intervention  + condition:intervention +  bmi_diff_z + gender + ageZ + (time*condition|id) + (1|trialxcondition), data = OBIWAN_HED, control=control, REML = FALSE)
#drop main
null = lmer(perceived_liking ~ condition + intervention   + condition:intervention  +  bmi_diff_z + gender + ageZ + (time*condition|id) + (1|trialxcondition), data = OBIWAN_HED, control=control, REML = FALSE)
...
full = lmer(perceived_liking ~ condition + time + intervention  + time:intervention  +  bmi_diff_z + gender + ageZ + (time*condition|id) + (1|trialxcondition), data = OBIWAN_HED, control=control, REML = FALSE)
#drop main
null = lmer(perceived_liking ~  time + intervention  + time:intervention  +  bmi_diff_z + gender + ageZ + (time*condition|id) + (1|trialxcondition), data = OBIWAN_HED, control=control, REML = FALSE)
...
null <- lmer(perceived_liking ~  time + intervention  + time:intervention  +  bmi_diff_z + gender + ageZ + (time|id) + (1|trialxcondition), data = OBIWAN_HED, control=control, REML = FALSE)

r1 = r.squaredGLMM(full)
r2 = r.squaredGLMM(null)
r1[2] -  r2[2]   #this value thus reflects the conditional R2 for the condition effect # R2c = 0.46
...
model = lmer(perceived_liking ~ condition + time + intervention   +  bmi_diff_z + gender + ageZ + (time*condition|id) + (1|trialxcondition), data = OBIWAN_HED, control=control)
...
plt1 =  plt +   #details
  ...
  labs(  y = "Plesantness Ratings (z)",
        ...
        Marginal effect (p < 0.0001, \u0394 AIC = 23.02, R\u00B2c = 0.46), N = 61")
...
model = lmer(perceived_liking ~ condition + time + intervention   +  bmi_diff_z + gender + ageZ + intervention:condition + (time*condition|id) + (1|trialxcondition), data = OBIWAN_HED, control=control)
...
cairo_pdf(file.path(figures_path,paste(task, 'Liking_condXtreatXtime.pdf',  sep = "_")),
          width     = 5.5,
          height    = 6)
