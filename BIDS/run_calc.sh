...
#do control
qsub -o ${home}/OBIWAN/ClusterOutput -j oe -l walltime=300:00:00,pmem=16GB -M david.munoz@etu.unige.ch -m n -l nodes=1 -q queue1 -N QC_16-30_${group} -F "${group}" ${Script} 
