...
% on swallowing signal w/ stick function; parametric modulators control vs. reward w/ more accurate model of events of non-interest
...
name_ana = 'GLM-12-control'; % output folder for this analysis
