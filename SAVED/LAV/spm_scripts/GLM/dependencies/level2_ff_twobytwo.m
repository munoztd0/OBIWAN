function matlabbatch = level2_ff_twobytwo(condirpat, factors, varargin)

% I made this based on bob's bspm_level2_ff_twoway
...
%           factors(n).idx2con = 'name of the constrasts'
%           factors(n).level = 'of the level is of the factor is specified along idx2con'
%           factors(2).idx2con = {'con-0006', 'con-0007',  'con-0022',  'con-0023'};
...
I(:,4)  = repmat(factors(2).level, 1, nsub)'; % second factor
