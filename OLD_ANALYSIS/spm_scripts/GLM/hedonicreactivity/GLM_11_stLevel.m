...
% on swallowing signal; parametric modulators w/ 2 second durations control vs. reward w/ more accurate model of events of non-interest
...
name_ana = 'GLM-11-control'; % output folder for this analysis
...
%                         SPM.Sess(ses).C.name = rnam;
    ...
    function [] = doContrasts(subjoutdir, param, SPM)
        ...
        % con2
        Ctnames{2} = 'liking';
        weightPos  = ismember(conditionName, {'run1.swallowxreward^1'}) * 1;
        Ct(2,:)    = weightPos;
