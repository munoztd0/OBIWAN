...
# will generate a label file at the specified threshold called fix4melview_FIX_obiwan_thr<threshold>.txt
...
#/usr/local/fix1.066/fix -a ${funcDir}/fix4melview_FIX_giovanniCoins_jeffCasinoUSA_thr${threshold}.txt -m
