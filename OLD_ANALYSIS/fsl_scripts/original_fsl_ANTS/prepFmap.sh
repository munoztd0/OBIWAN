...
fslreorient2std ${dataDir}fmap/sub-${subjectID}_ses-${sessionID}_acq-task-${taskID}_magnitude1 ${outDir}fmap/sub-${subjectID}_ses-${sessionID}_acq-task-${taskID}_magnitude1_reoriented
...
fslreorient2std ${dataDir}fmap/sub-${subjectID}_ses-${sessionID}_acq-task-${taskID}_phasediff ${outDir}fmap/sub-${subjectID}_ses-${sessionID}_acq-task-${taskID}_phasediff_reoriented
...
bet ${outDir}fmap/sub-${subjectID}_ses-${sessionID}_acq-task-${taskID}_magnitude1_reoriented.nii.gz ${outDir}fmap/sub-${subjectID}_ses-${sessionID}_acq-task-${taskID}_magnitude1_brain1 -f 0.5 -R
...
# create fieldmap
#fsl_prepare_fieldmap SIEMENS ${dataDir}fmap/sub-${subjectID}_ses-${sessionID}_acq-task-${taskID}_phasediff.nii.gz ${outDir}fmap/sub-${subjectID}_ses-${sessionID}_acq-task-${taskID}_magnitude1_brain ${outDir}fmap/sub-${subjectID}_ses-${sessionID}_acq-task-${taskID}_fmap_rads 2.64
fsl_prepare_fieldmap SIEMENS ${outDir}fmap/sub-${subjectID}_ses-${sessionID}_acq-task-${taskID}_phasediff_reoriented.nii.gz ${outDir}fmap/sub-${subjectID}_ses-${sessionID}_acq-task-${taskID}_magnitude1_brain ${outDir}fmap/sub-${subjectID}_ses-${sessionID}_acq-task-${taskID}_fmap_rads 2.46
