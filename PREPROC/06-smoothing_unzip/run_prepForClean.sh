  ...
  subjectID=${group}${subjID}
	...
	do
		...
		do
				...
				qsub -o /home/OBIWAN/ClusterOutput -j oe -l walltime=1:00:00,pmem=4GB -M david.munoz@etu.unige.ch -m n -l nodes=1 -q queue1 -N smooth_${subjectID}_${sessionID}_${taskID} -F "${subjectID} ${sessionID} ${taskID}" ${smoothScript}
